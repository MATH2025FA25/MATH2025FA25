...
The data set for this assignment contains house sale prices for King County, which includes Seattle, from homes sold between May 2014 and May 2015. It was originally Obtained from [Kaggle.com](https://www.kaggle.com/harlfoxem/housesalesprediction/data). Our goal will be to try and predict the sale price of a house from the houses square footage.
