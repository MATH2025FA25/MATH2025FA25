...
::: appex
📋 [AE 05 - Simulation Based Inference](https://deepnote.com/workspace/CofI-MATH-269748c4-4966-4cc3-b064-2a31b9db85a4/project/Eric-Friedlanders-Untitled-project-a50d53f1-7c77-4add-8c8b-898d3ea049d6/notebook/Init-f04e0c5b989743a1b76aea279b0c034a?utm_source=share-modal&utm_medium=product-shared-content&utm_campaign=notebook&utm_content=a50d53f1-7c77-4add-8c8b-898d3ea049d6)
:::
...
null_dist <- do(1000) * lm(shuffle(Number_Organic) ~ Avg_Income_K, data = heb)
```
...
null_dist |>
  gf_histogram(~Avg_Income_K, color = "white") |>
  gf_labs(
    x = "Slope",
    y = "Count",
    title = "Slopes of 1000 permuted samples"
...
null_slopes <- null_dist$Avg_Income_K
p_value <- mean(abs(null_slopes) >= abs(0.9591))
p_value
```
