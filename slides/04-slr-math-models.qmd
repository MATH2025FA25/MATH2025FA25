...
<!-- x_new <- 70 -->
<!-- y_hat_x_new <- predict(spotify_fit, newdata = tibble(Avg_Income_K = x_new)) -->

<!-- ggplot(spotify, aes(x = Avg_Income_K, y = Number_Organic)) + -->
<!--   geom_segment( -->
...
<!-- 2.  Prediction for an individual observation: "What is the predicted number of organic vegetable options at a single spotify in a neighborhood with an average income of \$70k?" -->
...
<!-- predict(spotify_fit, newdata = new_neighborhood, interval = "confidence", level = 0.95) |> -->
<!--   kable() -->
<!-- ``` -->

<!-- ```{r} -->
<!-- #| echo: false -->
<!-- new_neighborhood_ci <- as.tibble(predict(spotify_fit, newdata = new_neighborhood, interval = "confidence", level = 0.95) ) -->
<!-- ``` -->

<!-- . . . -->

<!-- * We are 95% confident that the *mean* number of organic vegetable options offered by spotify in a neighborhood with an average income of \$70k is between . -->
...
<!-- ```{r} -->
<!-- #| echo: true -->
<!-- predict(spotify_fit, newdata = new_neighborhood, interval = "prediction", level = 0.95) |> -->
<!--   kable() -->
<!-- ``` -->

<!-- ```{r} -->
<!-- #| echo: false -->
<!-- new_neighborhood_pi <- as.tibble(predict(spotify_fit, newdata = new_neighborhood, interval = "prediction", level = 0.95)) -->
<!-- ``` -->

<!-- . . . -->

<!-- We are 95% confident that the number of organic vegetable options offered by spotify in a neighborhood with an average income of \$70k is between -->
...
<!-- new_neighborhoods <- tibble(Avg_Income_K = seq(min(spotify$Avg_Income_K), max(spotify$Avg_Income_K), diff(range(spotify$Avg_Income_K))/30)) -->
<!-- new_neighborhood_ci <- as.tibble(predict(spotify_fit, newdata = new_neighborhoods, interval = "confidence", level = 0.95)) |> -->
<!--   mutate( -->
<!--     Avg_Income_K = new_neighborhoods$Avg_Income_K, -->
<!--     type = "Confidence interval" -->
<!--     ) -->
<!-- new_neighborhood_pi <- as.tibble(predict(spotify_fit, newdata = new_neighborhoods, interval = "prediction", level = 0.95)) |> -->
<!--   mutate( -->
<!--     Avg_Income_K = new_neighborhoods$Avg_Income_K, -->
