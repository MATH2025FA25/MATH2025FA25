...
\tightlist
\item
  \textbf{Course Name}: Multiple Regression Analysis
\item
  \textbf{Course Code}: MATH-2025
\end{itemize}
...
(CML) 208 \\
\textbf{Office Hours} & Mon 3:30 - 4:30pm Tue 10:20 - 11:20am Thu 1:30 -
3:30pm & Boone 126B \\
\end{longtable}
...
An introduction to statistical modeling and methods. Topics may include
model construction and analysis using multiple linear regression,
analysis of variance, and logistic regression. The course makes
substantial use of statistical software. Students who have taken more
than one calculus course should generally take MAT-2025 rather than
MAT-1025.

\subsubsection{Pre-requisites}\label{pre-requisites}

MATH-2025, grade of C- or better; or CSCI-1040, grade of C- or better;
...
information. Barring extenuating circumstances, I will respond to MATH
...
\item
  \href{https://introregression.netlify.app/}{Introduction to Regression
  Analysis: A Data Science Approach} by Maria Tackett
\end{itemize}
...
.pdf file for their AE before the start of the next lecture. Students
with an excused absence will be graded for completion, students without
...
There will be two in-class exams in this course. Each exam will be
completed without a computer and will be closed notes. Through these
exams you have the opportunity to demonstrate what you've learned in the
course thus far. The exams will focus on conceptual understanding of the
content. The content of the exam will be related to the content in
reading assignments, lectures, application exercises, and homework
assignments. More detail about the exams will be given during the
semester. Please note the following course policy: You MUST receive at
least an average of 60\% on your exams to pass the class.
...
be completed in groups of two, and each group will present their work
through a written report and poster presentation taking place during the
final exam. More information about the project will be provided during
the semester.
...
\item
  ...
  cited will be treated as plagiarism. Furthermore, \textbf{you are
  responsible for understanding the code you submit}.
\item
  \textbf{Coding conventions}: Unless explicitly stated otherwise, you
  are expected to complete all assignments using only function and
  packages introduced in class. If you would like to use a different set
  of tools, you must email Dr.~Friedlander for permission. Any code that
  deviates from the conventions of the course will receive zero credit.
\item
  \textbf{Use of artificial intelligence (AI)}: I will be honest, AI can
  correctly complete many, of the problems that I assign you in class,
  and frankly, I believe that using LLMs to generate code will be an
  important skill for the workplace. However, I also believe that we are
  a long way away from a world in which you will be using AI to write a
  lot of code that you could not generate and understand yourself. Here
...
\tightlist
\item
  Can you achieve \textbf{Task X} \emph{faster} with an LLM, compared to
  your peers? If you take an hour to do \textbf{Task X}, but your peers
  take a few minutes to do \textbf{Task X}, why should someone slower be
  hired?
\item
  Can you achieve \textbf{Task X} \emph{correctly} with an LLM, compared
  to your peers? If \textbf{Task X} is done incorrectly with an LLM, but
  your peers do \textbf{Task X} correctly with an LLM, why should
  someone who gives wrong answers be hired? Moreover, if you \emph{can't
  evaluate} whether an answer that an LLM gives is correct, why should
  you be hired?
\item
  Can you achieve \textbf{Task X} using less energy output with an LLM,
  compared to your peers? If you use 10 million tokens to do
  \textbf{Task X}, but your peers only need 1 million tokens to do
  \textbf{Task X} with an LLM, why should someone wasting energy and
  money be hired?
\item
  Can you accurately describe how you used LLMs to achieve \textbf{Task
  X}, so someone else knows what to check (in case an LLM screws up)? If
  you cannot describe how you used an LLM, or if you claim you did not
  use one when you did, why would someone unreliable be hired?
\end{enumerate}

This is a 2000-level class, meaning we are still providing you with the
foundational knowledge necessary to succeed in more advanced courses. I
will frequently be asking you to complete exercises without the use of
AI, even though AI can complete them. The reason is that the skills and
knowledge you gain from this course will (a) be built on in future
courses and (b) be instrumental to items 1--4 above. Understanding how
to write and structure code is instrumental to effectively prompting AI
to do the things you want it to do, more accurately, more quickly, and
with less effort.
\href{https://www.youtube.com/watch?v=A_YE9dC7YdE}{Here is a short
video} that I think provides an interesting take from someone who isn't
one of your professors.

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, leftrule=.75mm, rightrule=.15mm, colback=white, toprule=.15mm, bottomrule=.15mm, left=2mm, opacitybacktitle=0.6, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, opacityback=0, colframe=quarto-callout-important-color-frame, coltitle=black, toptitle=1mm, titlerule=0mm, breakable, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}]
